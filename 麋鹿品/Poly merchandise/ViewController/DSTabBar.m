...
- (void)setupPlusButton {
    ...
    // 设置背景
    [plusButton setBackgroundImage:[UIImage imageWithName:@"circle.png"] forState:UIControlStateNormal];
//    [plusButton setBackgroundImage:[UIImage imageWithName:@"circle.png"] forState:UIControlStateHighlighted];
    // 设置图标
    [plusButton setImage:[UIImage imageWithName:@"circle.png"] forState:UIControlStateNormal];
//    [plusButton setImage:[UIImage imageWithName:@"circle.png"] forState:UIControlStateHighlighted];
...
- (void)setupPlusButtonFrame {
    ...
    self.plusButton.center = CGPointMake(self.width * 0.5, self.height * 0.4);
}
